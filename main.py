...
while True:
    ...
    if operation == "add":
        ...
        break
    else: #operation != "add" and operation != "subtract" and operation != "multiply" and operation != "divide" and operation and "exponent" and operation != "modulo" and operation != "floor_divide" and operation != "absolute" and operation != "exit":
